...
;   └─────────┼─────────┼─────────┼─────────┼─────────┬─────────┤
;             │         │ ^+T|!+T │  F6|#↑  │  ^T|!T  │         │ 9 6 3
;             │         │  F7|F10 │  F8|F11 │  F9|F12 │  Esc    │ 8 5 2
...
;             ├─────────┼─────────┼─────────┼─────────┤  Space  │
;             │         │  ^-|#-  │!Spc|#Esc│  ^+|#+  │         │ 9 6 3
;             │         │  F1|F4  │  F2|^n  │  ^t|^w  │         │ 8 5 2
;             │         │ Vol-|End│ Mute|App│Vol+|PgDn│         │ 7 4 1
;             └─────────┴─────────┴─────────┴─────────┴─────────┘
...
;             ├─────────┼─────────┼─────────┼─────────┤  Space  │
;             │         │  ^-|#-  │!Spc|#Esc│  ^+|#+  │         │ 9 6 3
;             │         │Back|Prev│PrSc|AppM│ Fwd|Next│         │ 8 5 2
;             │         │ Vol-|End│Mute|Paus│Vol+|PgDn│         │ 7 4 1
;             └─────────┴─────────┴─────────┴─────────┴─────────┘
...
Numpad9 & Numpad8::SendInput, {U+2260}
...
Numpad3 & Numpad8::SendInput, {U+00A3}
Numpad3 & Numpad2::SendInput, {Raw}=

;             ├─────────┼─────────┼─────────┼─────────┼─────────┤
;             │         │ {  S  % │ q  u  p │ |  C  } │         │ 9 6 3
;             │ Down    │ (  h  k │ c  o  b │ m  r  ) │         │ 8 5 2
;             │         │ [  I  _ │ g  d  j │ @  N  ] │         │ 7 4 1
;             ├─────────┼─────────┼─────────┼─────────┤  Space  │
...
Numpad7 & Numpad6::SendInput, {U+00B1}
Numpad7 & Numpad9::SendInput, {U+2264}
Numpad7 & Numpad3::SendInput, {Raw}0
Numpad7 & Numpad1::SendInput, {Raw}<
Numpad7 & Numpad2::SendInput, {Raw}~
Numpad7 & Numpad8::SendInput, {U+2248}
...
Numpad1 & Numpad3::SendInput, {U+2265}
...
NumpadDot & Numpad8::SendInput, ^{z}
Numpad5 & NumpadDot::SendInput, ^{s}
NumpadDot & Numpad5::SendInput, ^{s}
Numpad2 & NumpadDot::SendInput, ^+{z}
...
NumpadDot & Numpad4::SendInput, {AppsKey}
...
Numpad0 & Numpad4::SendInput, {Media_Play_Pause}
